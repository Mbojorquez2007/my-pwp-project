...
namespace Edu\Cnm\MyPwpProject\Test;

use Edu\Cnm\MyPwpProject\Test\MyPwpProjectTest;
use Edu\Cnm\MyPwpProject\Post;

//grab the project test parameters
require_once ("MyPwpProjectTest.php");
 ...
 **/
class PostTest extends MyPwpProjectTest {
	/**
	 * content of the Post
	...
	public function testInsertInvalidPost() {
		...
		$post = new Post(MyPwpProjectTest::INVALID_KEY, $this->VALID_CONTENT, $this->VALID_DATE, $this->VALID_TITLE);
		$post->insert($this->getPDO());
	}
	...
	public function testGetValidPostsByPostTitle() {
		...
		$this->assertEquals($numRows + 1, $this->getConnection()->getRowCount("post"));
		$this->assertCount(1, $results);
		$this->assertContainsOnlyInstancesOf("Edu\\Cnm\\MyPwpProject\\Post", $results);

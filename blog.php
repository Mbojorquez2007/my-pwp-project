...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="../my-pwp-project/vendor/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="static-ui/css/stylesheet.css" rel="stylesheet">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="../my-pwp-project/about.html">About</a>
            </li>
    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
        <div class="card card-inverse">
          <img class="card-img img-fluid w-100" src="static-ui/img/slide-1.jpg" alt="slide">
          <div class="card-img-overlay bg-overlay">
            <h2 class="card-title text-shadow text-white text-uppercase mb-0">Post Title</h2>
            <h4 class="text-shadow text-white">August 28, 2017</h4>
      ...
      <div class="bg-faded p-4 my-4">
        <div class="card card-inverse">
          <img class="card-img img-fluid w-100" src="static-ui/img/slide-2.jpg" alt="slide">
          <div class="card-img-overlay bg-overlay">
            <h2 class="card-title text-shadow text-white text-uppercase mb-0">Post Title</h2>
            <h4 class="text-shadow text-white">Aug 24, 2017</h4>
            <p class="lead card-text text-shadow text-white w-50 d-none d-lg-block">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit repellat provident quo aliquam eius ea, animi porro magnam totam dolor nam error quas labore eveniet dicta nostrum inventore veniam. Ipsam?</p>
            <a href="#" class="btn btn-secondary">Read More</a>
          </div>
        </div>
    ...
    <script src="../my-pwp-project/vendor/vendor/jquery/jquery.min.js"></script>
    <script src="../my-pwp-project/vendor/vendor/popper/popper.min.js"></script>
    <script src="../my-pwp-project/vendor/vendor/bootstrap/js/bootstrap.min.js"></script>
